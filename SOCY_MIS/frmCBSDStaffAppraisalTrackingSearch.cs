...
namespace SOCY_MIS
{
    public partial class frmCBSDStaffAppraisalTrackingSearch : UserControl
    {
        #region Variables
        ...
        #region Form Methods
        public frmCBSDStaffAppraisalTrackingSearch()
        {
            InitializeComponent();
        }

        private void frmCBSDStaffAppraisalTrackingSearch_Load(object sender, EventArgs e)
        {
        ...
        private void frmCBSDStaffAppraisalTrackingSearch_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void dgvRegister_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                #region Variables
                frmCBSDStaffAppraisalTracking frmNew = null;
                ...
                if (dgvRegister.SelectedCells.Count != 0)
                {
                    ...
                    frmNew = new frmCBSDStaffAppraisalTracking();
        ...
        {
            #region Set Selected
            frmCBSDStaffAppraisalTracking frmNew = new frmCBSDStaffAppraisalTracking();
            frmNew.FormCalling = this;
            frmNew.FormParent = FormParent;
            FormParent.LoadControl(frmNew, this.Name);
            #endregion
        ...
        private void Clear()
        {
            try
            {
                ...
                DataAccessLayer.DBConnection dbCon = null;
                DataTable dt = null;
                prtCBSDStaffAppraisalTracking dalCRA = null;
                #endregion Variables
                ...
                {
                    #region Set Dates
                    dalCRA = new prtCBSDStaffAppraisalTracking();
                    dt = dalCRA.GetDateRange(dbCon);
        ...
        private void Delete()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                prtCBSDStaffAppraisalTracking dalDel = null;
                        ...
                        if (blnFound)
                        {
                            ...
                            if (dlrResult == DialogResult.Yes)
                            {
                                try
                                {
                                    ...
                                    dalDel = new prtCBSDStaffAppraisalTracking();
        ...
        private void Search()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                prtCBSDStaffAppraisalTracking dalCSAT = new prtCBSDStaffAppraisalTracking();
