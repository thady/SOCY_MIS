...
namespace SOCY_MIS
{
    public partial class frmYouthAssessmentScoringToolSearch : UserControl
    {
        #region Variables
        DataTable dt = null;
        ...
        #endregion Property
        public frmYouthAssessmentScoringToolSearch()
        {
            InitializeComponent();
        }

        private void frmYouthAssessmentScoringToolSearch_Load(object sender, EventArgs e)
        {
            Return_lookups();
            LoadDisplay();
        }
        ...
        private void lnlAssessment_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            frmYouthAssessmentScoringTool frmNew = new frmYouthAssessmentScoringTool();
        ...
        {
            dt = benYouthAssessmentScoring.LoadDisplayList();
            if (dt.Rows.Count > 0)
            {
                gdvYouthList.DataSource = dt;
                gdvYouthList.Columns["yas_id"].Visible = false;
        ...
        {
            dt = benYouthAssessmentScoring.Search(cboDistrict.SelectedValue.ToString(), cboSubCounty.SelectedValue.ToString(), cboIP.SelectedValue.ToString(), cboCso.SelectedValue.ToString(), txtYouthName.Text, txtHHCode.Text);
        ...
        private void gdvYouthList_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                #region Set Selected
                benYouthAssessmentScoring.yas_id = gdvYouthList.CurrentRow.Cells[0].Value.ToString();
                frmYouthAssessmentScoringTool frmNew = new frmYouthAssessmentScoringTool();
                frmNew.FormCallingSearch = this;
                frmNew.FormMaster = FormParent.FormMaster;
                frmNew.FormParent = FormParent;
