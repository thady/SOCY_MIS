...
namespace SOCY_MIS
{
    public partial class frmDREAMSSteppingStonesAttendanceRegisterSearch : UserControl
    {
        #region Variables
        ...
        #region Form Methods
        public frmDREAMSSteppingStonesAttendanceRegisterSearch()
        {
            InitializeComponent();
        }

        private void frmDREAMSSteppingStonesAttendanceRegisterSearch_Load(object sender, EventArgs e)
        {
        ...
        private void frmDREAMSSteppingStonesAttendanceRegisterSearch_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void dgvRegister_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                #region Variables
                frmDREAMSSteppingStonesAttendanceRegister frmNew = null;
                ...
                if (dgvRegister.SelectedCells.Count != 0)
                {
                    ...
                    frmNew = new frmDREAMSSteppingStonesAttendanceRegister();
        ...
        {
            #region Set Selected
            frmDREAMSSteppingStonesAttendanceRegister frmNew = new frmDREAMSSteppingStonesAttendanceRegister();
            frmNew.FormCalling = this;
        ...
        private void Clear()
        {
            try
            {
                ...
                try
                {
                    ...
                    dt = dalDssr.GetDateRange(dbCon);
                    dtpDateFrom.Value = Convert.ToDateTime(dt.Rows[0]["dssr_date_from"]);
                    dtpDateTo.Value = Convert.ToDateTime(dt.Rows[0]["dssr_date_to"]);
                    #endregion Set Dates
        ...
        private void Delete()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                drmSteppingStonesRegister dalDel = null;
                        ...
                        if (blnFound)
                        {
                            ...
                            if (dlrResult == DialogResult.Yes)
                            {
                                try
                                {
                                    ...
                                    dalDel = new drmSteppingStonesRegister();
        ...
        private void LoadLists(string strFacilitator, string strGroup, string strDstId, string strSctId, string strWrdId, DataAccessLayer.DBConnection dbCon)
        {
            try
            {
                ...
                dt = dalDssr.GetFacilitator(dbCon);
        ...
        private void Search(bool blnBack)
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                drmSteppingStonesRegister dalDssr = new drmSteppingStonesRegister();
                ...
                try
                {
                    ...
                    if (cbGroup.SelectedIndex != 0)
                    {
                        arrFilter[intArrayLength, 0] = "dssr_group";
                    ...
                    dt = dalDssr.GetByCriteria(arrFilter, intArrayLength, FormParent.FormMaster.LanguageId, dbCon);
                    pblnSearched = true;
                    #endregion Search
                }
                finally
