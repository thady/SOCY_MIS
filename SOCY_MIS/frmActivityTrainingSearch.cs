...
namespace SOCY_MIS
{
    public partial class frmActivityTrainingSearch : UserControl
    {
        #region Variables
        ...
        #region Form Methods
        public frmActivityTrainingSearch()
        {
            InitializeComponent();
        }

        private void frmActivityTrainingSearch_Load(object sender, EventArgs e)
        {
        ...
        private void frmActivityTrainingSearch_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void dgvRegister_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                #region Variables
                frmActivityTraining frmNew = null;
                ...
                if (dgvRegister.SelectedCells.Count != 0)
                {
                    ...
                    frmNew = new frmActivityTraining();
        ...
        private void llblNewActivityTraining_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            #region Set Selected
            frmActivityTraining frmNew = new frmActivityTraining();
            frmNew.FormCalling = this;
            frmNew.FormParent = FormParent;
            FormParent.LoadControl(frmNew, this.Name);
            #endregion
        ...
        public void BackDisplay()
        {
            if (!FormParent.FormMaster.NoDatabase)
            {
                ...
                try
                {
                    ...
                    dt = dalAT.GetDateRange(dbCon);
                    dtpTrainingFrom.Value = Convert.ToDateTime(dt.Rows[0]["at_date_begin"]);
                    dtpTrainingTo.Value = Convert.ToDateTime(dt.Rows[0]["at_date_end"]);
                    #endregion Set Dates
        ...
        private void Delete()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                benActivityTraining dalDel = null;
                        ...
                        if (blnFound)
                        {
                            ...
                            if (dlrResult == DialogResult.Yes)
                            {
                                try
                                {
                                    ...
                                    dalDel = new benActivityTraining();
        ...
        private void Search()
        {
            try
            {
                ...
                try
                {
                    ...
                    arrFilter[intArrayLength, 0] = "at_date_begin";
                    arrFilter[intArrayLength, 1] = dtpTrainingFrom.Value.ToString("dd MMM yyyy");
                    intArrayLength++;
                    arrFilter[intArrayLength, 0] = "at_date_end";
                    arrFilter[intArrayLength, 1] = dtpTrainingTo.Value.ToString("dd MMM yyyy");
                    intArrayLength++;
                    ...
                    dt = dalAT.GetByCriteria(arrFilter, intArrayLength, FormParent.FormMaster.LanguageId, dbCon);
                    pblnSearched = true;
                    #endregion Search
                }
                finally
