...
namespace SOCY_MIS
{
    public partial class frmCBSDResourceAllocationSearch : UserControl
    {
        #region Variables
        ...
        #region Form Methods
        public frmCBSDResourceAllocationSearch()
        {
            InitializeComponent();
        }

        private void frmCBSDResourceAllocationSearch_Load(object sender, EventArgs e)
        {
        ...
        private void frmCBSDResourceAllocationSearch_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void dgvRegister_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                #region Variables
                frmCBSDResourceAllocation frmNew = null;
                ...
                if (dgvRegister.SelectedCells.Count != 0)
                {
                    ...
                    frmNew = new frmCBSDResourceAllocation();
        ...
        {
            #region Set Selected
            frmCBSDResourceAllocation frmNew = new frmCBSDResourceAllocation();
            frmNew.FormCalling = this;
            frmNew.FormParent = FormParent;
            FormParent.LoadControl(frmNew, this.Name);
            #endregion
        ...
        private void Delete()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                prtCBSDResourceAllocation dalDel = null;
                        ...
                        if (blnFound)
                        {
                            ...
                            if (dlrResult == DialogResult.Yes)
                            {
                                try
                                {
                                    ...
                                    dalDel = new prtCBSDResourceAllocation();
        ...
        private void Search()
        {
            try
            {
                ...
                try
                {
                    ...
                    dt = dalCRA.GetByCriteria(arrFilter, intArrayLength, FormParent.FormMaster.LanguageId, dbCon);
                    pblnSearched = true;
                    #endregion Search
                }
                finally
