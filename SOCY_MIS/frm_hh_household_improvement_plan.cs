...
namespace SOCY_MIS
{
    public partial class frm_hh_household_improvement_plan : Form
    {
        DataTable dt = null;
        public frm_hh_household_improvement_plan()
        {
            InitializeComponent();
        }

        private void frm_hh_household_improvement_plan_Load(object sender, EventArgs e)
        {
        ...
        protected bool ValidateIput()
        {
            ...
            if ((rbtnStatusYes.Checked == false && rbtnStatusNo.Checked == false) || (rdnArtYes.Checked == false && rdnArtNo.Checked == false && rdnArtNA.Checked == false)
                ...
                (rdnMealsYes.Checked == false && rdnMealsNo.Checked == false) || (rdnAttendingSchoolYes.Checked == false && rdnAttendingSchoolNo.Checked == false) ||
        ...
        #endregion Safety Triggers

        #region Stable Triggers
        ...
        #endregion Stable Triggers

        #region Schooled Triggers
        ...
        private void rdnTechnicalNA_CheckedChanged(object sender, EventArgs e)
        {
            TriggerSchooledRequiredValues();
        }

        #endregion Schooled Triggers
        ...
        protected void Return_HipDetails(string hip_id)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                utilControls.RadioButtonSetSelection(rdnAttendingSchoolYes, rdnAttendingSchoolNo, dtRow["schooled_all_attending_school"].ToString());
                utilControls.RadioButtonSetSelection(rdnTechnicalYes, rdnTechnicalNo, rdnTechnicalNA, dtRow["health_enrolled_on_art"].ToString());
