...
namespace SOCY_MIS
{
    public partial class frmEducationSubsidySearch : UserControl
    {
        public frmEducationSubsidySearch()
        {
            InitializeComponent();
        }
        ...
        private void frmEducationSubsidySearch_Load(object sender, EventArgs e)
        {
            Return_lookups();
        ...
        private void lnlAssessment_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            #region Set Selected
            frmEducationSubsidy frmNew = new frmEducationSubsidy();
        ...
        {
            dt = benEducationSubsidy.ReturnAssessmentList();
            if (dt.Rows.Count > 0)
            {
                gdvTrainingList.DataSource = dt;

                gdvTrainingList.Columns["ed_sub_id"].Visible = false;
                ...
                gdvTrainingList.Columns["assessment_date"].HeaderText = "Assessment Date";
        ...
        private void gdvTrainingList_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                string ed_sub_id = gdvTrainingList.CurrentRow.Cells[5].Value.ToString();
                benEducationSubsidy.ed_sub_id = ed_sub_id;
        ...
        {
            dt = benEducationSubsidy.ReturnAssessmentList(cboDistrict.SelectedValue.ToString(), cboSubCounty.SelectedValue.ToString(),
