...
namespace SOCY_MIS
{
    public partial class frmSocialWorker : UserControl
    {
        #region Variables
        ...
        private void frmSocialWorker_Paint(object sender, PaintEventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        //btnSave.Enabled = pblnManage && (FormMaster.OfficeId.Equals(dalSwk.ofc_id) || utilConstants.cDFImportOffice.Equals(dalSwk.ofc_id) || SystemConstants.Validate_Office_group_access(FormMaster.OfficeId, dalSwk.ofc_id));

                        LoadLists(dalSwk.cso_id, dalSwk.hnr_id, dalSwk.sws_id, dalSwk.wrd_id, dbCon);
                    }
                    finally
                    {
                        dbCon.Dispose();
        ...
        private void LoadLists(string strCSOId, string strHnrId, string strSwsId, string strWrdId, DataAccessLayer.DBConnection dbCon)
        {
            try
            {
                #region Variables
        ...
        private string ValidateInput()
        {
            ...
            if (txtFirstName.Text.Trim().Length == 0 || txtLastName.Text.Trim().Length == 0 || txtPhone.Text.Trim().Length == 0 || cbWard.SelectedIndex == 0 || cbCSO.SelectedIndex == 0 || numTarget.Value == 0)
        ...
        private void SetPermissions()
        {
            ...
            try
            {
                pblnManage = dalUsr.HasPermission(FormMaster.UserId, utilConstants.cPMManageSocialWorder, dbCon);
