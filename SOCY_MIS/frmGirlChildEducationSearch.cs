...
namespace SOCY_MIS
{
    public partial class frmGirlChildEducationSearch : UserControl
    {
        #region Variables
        ...
        #region Form Methods
        public frmGirlChildEducationSearch()
        {
            InitializeComponent();
        }

        private void frmGirlChildEducationSearch_Load(object sender, EventArgs e)
        {
        ...
        private void frmGirlChildEducationSearch_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void dgvRegister_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                #region Variables
                frmGirlChildEducation frmNew = null;
                ...
                if (dgvRegister.SelectedCells.Count != 0)
                {
                    ...
                    frmNew = new frmGirlChildEducation();
        ...
        {
            #region Set Selected
            frmGirlChildEducation frmNew = new frmGirlChildEducation();
            frmNew.FormCalling = this;
            frmNew.FormParent = FormParent;
            FormParent.LoadControl(frmNew, this.Name);
            #endregion
        ...
        private void Delete()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                benGirlEducationRegister dalDel = null;
                        ...
                        if (blnFound)
                        {
                            ...
                            if (dlrResult == DialogResult.Yes)
                            {
                                try
                                {
                                    ...
                                    dalDel = new benGirlEducationRegister();
        ...
        private void LoadLists(string strCsoId, string strDstId, string strFyId, string strPrtId, string strQyId, string strSctId, DataAccessLayer.DBConnection dbCon)
        {
            try
            {
                ...
                LoadListsOrganization(strFyId, strCsoId, dbCon);
            }
            catch (Exception exc)
            {
        ...
        private void Search()
        {
            try
            {
                ...
                try
                {
                    ...
                    dt = dalGER.GetByCriteria(arrFilter, intArrayLength, FormParent.FormMaster.LanguageId, dbCon);
                    pblnSearched = true;
                    #endregion Search
                }
                finally
