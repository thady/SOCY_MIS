...
namespace SOCY_MIS
{
    public partial class frmHouseholdRiskAssessmentRegister : UserControl
    {
        DataTable dt = null;
        ...
        #endregion Property
        public frmHouseholdRiskAssessmentRegister()
        {
            InitializeComponent();
        }

        private void frmHouseholdRiskAssessmentRegister_Load(object sender, EventArgs e)
        {
            Return_lookups();
            display_hh_details();
            Return_household_members();

            if (hh_household_risk_assessment_header._ras_id != string.Empty)
            {
                LoadRASDisplay(hh_household_risk_assessment_header._ras_id);
            }
        ...
        protected void Return_hhm_ras_details(string hhm_id, string ras_id)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                utilControls.RadioButtonSetSelection(rdnAccidentalExposureYes, rdnAccidentalExposureNo, dtRow["yn_accidental_exposure"].ToString());
                utilControls.RadioButtonSetSelection(rdnDrugAbuseYes, rdnDrugAbuseNo, dtRow["yn_drug_abuse"].ToString());
                cboBeneficiaryName.SelectedValue = hhm_id;
        ...
        protected void reset_defaults()
        {
            ...
            rbtnTestResultNegative.Checked = false;
            rbtnTestResultNotDisclosed.Checked = false;
            rdnAccidentalExposureYes.Checked = false;
            rdnAccidentalExposureNo.Checked = false;
            rdnDrugAbuseYes.Checked = false;
            rdnDrugAbuseNo.Checked = false;
        ...
        protected void save_update_rasm_record()
        {
            if (lblras_id.Text == "lblras_id")
            {
                MessageBox.Show("Please select a household risk assessment record to save details for this member", "SOCY MIS Message Centre", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else if (cboBeneficiaryName.SelectedValue.ToString() == "-1")
            {
                MessageBox.Show("Household member is required", "SOCY MIS Message Centre", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else if (rbtnHIVstatusPos.Checked == false && rbtnHIVstatusNEG.Checked == false && rbtnHIVstatusUnknown.Checked == false)
            {
                MessageBox.Show("HIV status is required", "SOCY MIS Message Centre", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else if (rbtnHIVstatusPos.Checked == true && (rbtnArtYes.Checked == false && rbtnArtNo.Checked == false))
            {
                MessageBox.Show("Please indicate if beneficiary is on ART if positive!!", "SOCY MIS Message Centre", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                if (lblrasm_id.Text == "lblrasm_id")
                {
                    ...
                    hh_household_risk_assessment_beneficiaries.yn_accidental_exposure = utilControls.RadioButtonGetSelection(rdnAccidentalExposureYes, rdnAccidentalExposureNo);
                    hh_household_risk_assessment_beneficiaries.yn_drug_abuse = utilControls.RadioButtonGetSelection(rdnDrugAbuseYes, rdnDrugAbuseNo);
        ...
        protected void LoadRASDisplay(string ras_id)
        {
            DataTable dt = hh_household_risk_assessment_header.Return_RAS_details(ras_id);
            if (dt.Rows.Count > 0)
            {
                DataRow dtRow = dt.Rows[0];

                dtTimeVisistDate.Value = Convert.ToDateTime(dtRow["date_of_visit"]);
                lblras_id.Text = ras_id;
                cboPersonInterviewed.Text = dtRow["hhm_name"].ToString();
                ...
                return_assessment_members(ras_id);
        ...
        protected void set_child_test_eligibilityYes(RadioButton rad01, RadioButton rad02, RadioButton rad03, RadioButton rad04, RadioButton rad05, RadioButton rad06, RadioButton rad07, RadioButton rad08)
        {
            if (rad01.Checked == true || rad02.Checked == true || rad03.Checked == true || rad04.Checked == true || rad05.Checked == true || rad07.Checked == true || rad06.Checked == true || rad08.Checked == true)
            {
        ...
        protected void set_child_test_eligibilityNo(RadioButton rad01, RadioButton rad02, RadioButton rad03, RadioButton rad04, RadioButton rad05, RadioButton rad06, RadioButton rad07, RadioButton rad08)
        {
            if (rad01.Checked == true && rad02.Checked == true && rad03.Checked == true && rad04.Checked == true && rad05.Checked == true && rad06.Checked == true && rad07.Checked == true && rad08.Checked == true)
            {
        ...
        {
            set_child_test_eligibilityYes(rbtnHospitalYes, rbtnSiblingsDeceasedYes, rbtnAdultOrChildwithHIVorTBYes, rbtnParentsDeceasedYes, rbtnPoorHealthYes, rbtnBelowExpectedGradeYes, rdnAccidentalExposureYes, rdnDrugAbuseYes);
        }
        ...
        {
            set_child_test_eligibilityNo(rbtnHospitalNo, rbtnSiblingsDeceasedNo, rbtnAdultOrChildwithHIVorTBNo, rbtnParentsDeceasedNo, rbtnPoorHealthNo, rbtnBelowExpectedGradeNo, rdnAccidentalExposureNo, rdnDrugAbuseNo);
        }
        ...
        private void Back()
        {
            hh_household_risk_assessment_header._ras_id = string.Empty;
        ...
        private void rdnAccidentalExposureYes_CheckedChanged(object sender, EventArgs e)
        {
            set_child_test_eligibilityYes(rbtnHospitalYes, rbtnSiblingsDeceasedYes, rbtnAdultOrChildwithHIVorTBYes, rbtnParentsDeceasedYes, rbtnPoorHealthYes, rbtnBelowExpectedGradeYes, rdnAccidentalExposureYes, rdnDrugAbuseYes);
        }

        private void rdnDrugAbuseYes_CheckedChanged(object sender, EventArgs e)
        {
            set_child_test_eligibilityYes(rbtnHospitalYes, rbtnSiblingsDeceasedYes, rbtnAdultOrChildwithHIVorTBYes, rbtnParentsDeceasedYes, rbtnPoorHealthYes, rbtnBelowExpectedGradeYes, rdnAccidentalExposureYes, rdnDrugAbuseYes);
        }

        private void rdnAccidentalExposureNo_CheckedChanged(object sender, EventArgs e)
        {
            set_child_test_eligibilityNo(rbtnHospitalNo, rbtnSiblingsDeceasedNo, rbtnAdultOrChildwithHIVorTBNo, rbtnParentsDeceasedNo, rbtnPoorHealthNo, rbtnBelowExpectedGradeNo, rdnAccidentalExposureNo, rdnDrugAbuseNo);
        }

        private void rdnDrugAbuseNo_CheckedChanged(object sender, EventArgs e)
        {
            set_child_test_eligibilityNo(rbtnHospitalNo, rbtnSiblingsDeceasedNo, rbtnAdultOrChildwithHIVorTBNo, rbtnParentsDeceasedNo, rbtnPoorHealthNo, rbtnBelowExpectedGradeNo, rdnAccidentalExposureNo, rdnDrugAbuseNo);
        }
    }
