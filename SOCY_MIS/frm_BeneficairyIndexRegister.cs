...
namespace SOCY_MIS
{
    public partial class frm_BeneficairyIndexRegister : Form
    {
        #region Variables
        ...
        public frm_BeneficairyIndexRegister()
        {
            InitializeComponent();
        }

        private void frm_BeneficairyIndexRegister_Load(object sender, EventArgs e)
        {
            Return_lookups();
            LoadIndexCategory();
            LoadGender();
            ...
            LoadIndexBeneficiaryRecord();

            //lblid.Text = "a13405e9-a96a-4f91-85ae-44ca0c3baba7";
            LoadRecordDetails(lblid.Text);
        }

       protected void LoadIndexBeneficiaryRecord()
        {
            dt = benIndexRegistration.ReturnIndexBeneficiaryRecord(benIndexRegistration.hh_id);
            if (dt.Rows.Count > 0)
            {
                DataRow dtRow = dt.Rows[0];
                lblid.Text = dtRow["ibr_id"].ToString();
            }
            else
            {
                lblid.Text = "--";
        ...
        protected void save()
        {
            ...
            benIndexRegistration.hhm_id = cboIndexname.SelectedValue.ToString();
            benIndexRegistration.hhm_id_caregiver = cboCaregiver.SelectedValue.ToString();
            ...
            benIndexRegistration.index_name = cboIndexname.SelectedValue.ToString();
            ...
            benIndexRegistration.caregiver_name = cboCaregiver.SelectedValue.ToString();
        ...
        protected void LoadRecordDetails(string ibr_id)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cboIndexname.SelectedValue = dtRow["index_name"].ToString();
                ...
                cboCaregiver.SelectedValue = dtRow["hhm_id_caregiver"].ToString();
                ...
                cboIndexname_SelectedIndexChanged(cboIndexname, null);
            }
        }
        ...
        protected bool ValidateInput()
        {
            ...
            if (cboDistrict.SelectedValue.ToString() == "-1" || cboSubCounty.SelectedValue.ToString() == "-1" || dtpDate.Checked == false || cboEntryPoint.Text == string.Empty ||
                txtIncharge.Text == string.Empty || cboCategory.SelectedValue.ToString() == "-1" || cboIndexname.SelectedValue.ToString() == "-1" || txtAge.Text == string.Empty || cboSex.SelectedValue.ToString() == "-1"
                || cboCaregiver.SelectedValue.ToString() == "-1" || cboIndexSubCounty.SelectedValue.ToString() == "-1" ||
                ...
                (cboEntryPoint.Text == "Other" & txthealthfacility.Text == String.Empty))
            {
                isValid = false;
                strErrorMessage = "Missing required values";
            }
            else if (((cboCategory.SelectedValue.ToString() == benIndexRegistration.HIV_POS_ADULT || cboCategory.SelectedValue.ToString() == benIndexRegistration.HIV_POS_CHILD)
                && (!rbtnSupressNo.Checked & !rbtnSupressYes.Checked) || !dtArtDate.Checked))
            {
                isValid = false;
                strErrorMessage = "Please indicate whether beneficiary is suppressing";
            }
            else if(txtidentifier.Text == string.Empty & (cboCategory.SelectedValue.ToString() == "1" || cboCategory.SelectedValue.ToString() == "2" || cboCategory.SelectedValue.ToString() == "3"))
            {
                isValid = false;
                strErrorMessage = "Please enter index identifier";
            }
            else
            {
                isValid = true;
        ...
        protected void LoadHouseholdDetails()
        {
            dt = benIndexRegistration.ReturnHouseholdDetails(benIndexRegistration.hh_id);
            if (dt.Rows.Count > 0)
            {
                DataRow dtRow = dt.Rows[0];
                cboDistrict.SelectedValue = dtRow["dst_id"].ToString();
                cboIndexSubCounty.SelectedValue = dtRow["sct_id"].ToString();
                cboIndexParish.SelectedValue = dtRow["wrd_id"].ToString();
                txtIndexVillage.Text = dtRow["hh_village"].ToString();
            }

            dt = benIndexRegistration.ReturnHouseholdIndexMembers(benIndexRegistration.hh_id);
            if (dt.Rows.Count > 0)
            {
                DataRow dtRow = dt.Rows[0];
                DataRow EmptyRow = dt.NewRow();
                ...
                EmptyRow["hhm_id"] = "-1";
                dt.Rows.InsertAt(EmptyRow, 0);
                cboIndexname.DataSource = dt;
                cboIndexname.DisplayMember = "hhm_name";
                cboIndexname.ValueMember = "hhm_id";
            }

            dt = benIndexRegistration.ReturnCaregiverList(benIndexRegistration.hh_id);
            if (dt.Rows.Count > 0)
            {
                DataRow dtRow = dt.Rows[0];
                DataRow EmptyRow = dt.NewRow();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(strErrorMessage, "SOCY MIS Message", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void cboDistrict_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            #region Load SubCountys
            dt = silcCommunityTrainingRegister.Return_lookups("subcounty", cboDistrict.SelectedValue.ToString(), string.Empty, string.Empty, string.Empty);
        ...
        private void cboIndexname_SelectedIndexChanged(object sender, EventArgs e)
        {
            dt = benIndexRegistration.ReturnMemberDetails(cboIndexname.SelectedValue.ToString());
            if (dt.Rows.Count > 0)
            {
                DataRow dtRow = dt.Rows[0];
                cboSex.SelectedValue = dtRow["gnd_id"].ToString();
        ...
        private void cboIndexname_SelectionChangeCommitted(object sender, EventArgs e)
        {
            //dt = benIndexRegistration.ReturnMemberDetails(cboIndexname.SelectedValue.ToString());
            //if (dt.Rows.Count > 0)
            //{
        ...
        private void cboCategory_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtidentifier.Text = "NA";
            }

            if (cboCategory.SelectedValue.ToString() == benIndexRegistration.HIV_POS_CHILD)
            {
                
                dt = benIndexRegistration.ReturnHousehold_HIVPOS_Child(benIndexRegistration.hh_id);
                ...
                else
                {
                    ...
                    table.Columns.Add("hhm_name", typeof(string));
                    table.Columns.Add("hhm_id", typeof(string));
                    DataRow EmptyRow = dt.NewRow();
                    EmptyRow["hhm_name"] = "select one";
                    EmptyRow["hhm_id"] = "-1";
                    dt.Rows.InsertAt(EmptyRow, 0);
            ...
            else if (cboCategory.SelectedValue.ToString() == benIndexRegistration.HIV_POS_ADULT)
            {
                dt = benIndexRegistration.ReturnHousehold_HIVPOS_Adult(benIndexRegistration.hh_id);
            ...
            else if (cboCategory.SelectedValue.ToString() == benIndexRegistration.EXPOSED_INFANT)
            {
                dt = benIndexRegistration.ReturnHousehold_ExposedInfants(benIndexRegistration.hh_id);
            ...
            else if (cboCategory.SelectedValue.ToString() == benIndexRegistration.PREGNANT_ADOLESCENT)
            {
                dt = benIndexRegistration.ReturnHousehold_10_17_girls(benIndexRegistration.hh_id);
            ...
            else if (cboCategory.SelectedValue.ToString() == benIndexRegistration.FEMALE_SEXUAL_WORKER)
            {
                dt = benIndexRegistration.ReturnHousehold_FSW(benIndexRegistration.hh_id);
        ...
        private void cboIndexname_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void cboSocialWorker_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        {
            txtSocialWorkerPhone.Text = benIndexRegistration.ReturnSocialWorkerPhone(cboSocialWorker.SelectedValue.ToString());
        }
    }
}
