...
namespace SOCY_MIS
{
    public partial class frmInstitutionalCareSummarySearch : UserControl
    {
        #region Variables
        ...
        #region Form Methods
        public frmInstitutionalCareSummarySearch()
        {
            InitializeComponent();
        }

        private void frmInstitutionalCareSummarySearch_Load(object sender, EventArgs e)
        {
        ...
        private void frmInstitutionalCareSummarySearch_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void dgvRegister_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                #region Variables
                frmInstitutionalCareSummary frmNew = null;
                ...
                if (dgvRegister.SelectedCells.Count != 0)
                {
                    ...
                    frmNew = new frmInstitutionalCareSummary();
        ...
        {
            #region Set Selected
            frmInstitutionalCareSummary frmNew = new frmInstitutionalCareSummary();
            frmNew.FormCalling = this;
            frmNew.FormParent = FormParent;
            FormParent.LoadControl(frmNew, this.Name);
            #endregion
        ...
        private void Delete()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                prtInstitutionalCareSummary dalDel = null;
                        ...
                        if (blnFound)
                        {
                            ...
                            if (dlrResult == DialogResult.Yes)
                            {
                                try
                                {
                                    ...
                                    dalDel = new prtInstitutionalCareSummary();
        ...
        private void Search()
        {
            try
            {
                #region Variables
                DataAccessLayer.DBConnection dbCon = null;
                prtInstitutionalCareSummary dalCSAT = new prtInstitutionalCareSummary();
